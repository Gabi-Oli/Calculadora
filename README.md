...
- ⭐ **Avaliação do Serviço**: Seleção do nível de satisfação do atendimento com diferentes percentagens de gorjeta:
  ...
  - `10%` — Ruim
  - `5%` — Péssimo
- 👥 **Divisão entre Pessoas**: Possibilidade de indicar quantas pessoas vão dividir o pagamento.
- 💡 **Exibição do Resultado**: Apresentação clara do valor da gorjeta por pessoa em tempo real.
...
└── scripts.js    # Lógica de cálculo e comportamento interativo
```
...
Este projeto é livre para fins de estudo e desenvolvimento.
